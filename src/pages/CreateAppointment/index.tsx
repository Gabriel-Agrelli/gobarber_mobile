...
const CreateAppointment: React.FC = () => {
  ...
  const handleCreateAppointment = useCallback(async () => {
    try {
      ...
      reset({
        routes: [{ name: 'AppointmentCreated', params: { date: date.getTime() } }],
        index: 0,
      });
    } catch (error) {
      Alert.alert('Error ao criar agendamento', 'Ocorreu um erro ao tentar criar um agendamento, tente novamente');
    }
  ...
  return (
    <Container>
      <Header>
        ...
        <UserAvatar source={user.avatar_url ? { uri: user.avatar_url } : null} />
      </Header>
